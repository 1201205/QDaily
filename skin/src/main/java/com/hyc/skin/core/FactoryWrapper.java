...
public class FactoryWrapper implements LayoutInflaterFactory {
    private List<SkinChangeable> skinChangeables;
    private SkinViewInflater mViewInflater;
    private AppCompatActivity mAppCompatActivity;

    public FactoryWrapper(AppCompatActivity activity) {
        mAppCompatActivity = activity;
        skinChangeables = new ArrayList<>();
        mViewInflater = new SkinViewInflater();
    }
    ...
    public void changeSkin(){
        for (SkinChangeable skinChangeable:skinChangeables) {
            skinChangeable.skinChanged();
        }
    }
}
